...
$homepage = "http://localhost/pvpgn-stats-character-mod/";
$ladderroot = "http://localhost/pvpgn-stats-character-mod/"; /* can also be something like "http://www.myserver.net/ladder/" */
